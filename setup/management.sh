...
apt_install python3-flask links duplicity libyaml-dev python3-dnspython python3-dateutil python3-pip python3-dev python3-boto3
...
hide_output pip3 install --upgrade \
	...
	"idna>=2.0.0" "cryptography>=1.0.2" psutil
